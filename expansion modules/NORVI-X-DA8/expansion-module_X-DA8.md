...
product: NORVI X-DA8 — 8-Channel AC Digital Input Expansion
...
# X-DA8 — Expansion Reference

## Overview
The NORVI X-DA8 is an 8-channel digital input expansion module for the NORVI X industrial controller, providing optically isolated 110V AC / 230V AC inputs (up to 4 modules stackable for 32 inputs total). Typical use: monitoring switches, sensors, and machine states in industrial automation and PLC I/O expansion setups.

## Specs
| Spec | Value |
|---|---|
| Channels | 8 |
| Signal type | dry contact/AC |
| Resolution | 1bit |
...
| Conflicts with | X-R8, X-Q8, X-DI8 |
...
|---|---|---|---|
| 1 | Digital Input1 | via internal IO Expander | AC Digital Input (sink or source) |
| 2 | Digital Input2 | via internal IO Expander | AC Digital Input (sink or source) |
| 3 | Digital Input3 | via internal IO Expander | AC Digital Input (sink or source) |
| 4 | Digital Input4 | via internal IO Expander | AC Digital Input (sink or source) |
| 5 | Digital Input5 | via internal IO Expander | AC Digital Input (sink or source) |
| 6 | Digital Input6 | via internal IO Expander | AC Digital Input (sink or source) |
| 7 | Digital Input7 | via internal IO Expander | AC Digital Input (sink or source) |
| 8 | Digital Input8 | via internal IO Expander | AC Digital Input (sink or source) |
...
void setup()
{
  ...
  Serial.println("NORVI X-DA8 READY");
}
...
- Function-specific examples (MQTT publish, Modbus, etc.): `NORVI X-DA8_program.md`
