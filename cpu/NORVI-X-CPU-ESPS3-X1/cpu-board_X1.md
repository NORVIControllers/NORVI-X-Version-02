...
# NORVI X1 — CPU Board Reference

## Overview
NORVI X1 is the CPU module for NORVI's modular controller lineup, running on an ESP32-S3-WROOM-1U-N16R2. It mounts on a DIN rail, uses push-in terminals on the bottom, and comes in at 81 x 104 x 37.5 mm. Onboard you get a 2.0" TFT touchscreen, Ethernet, RS-485, and an RTC (DS3231), plus a 50-pin expansion port for adding I/O modules as needed.
...
| Average power consumption | 80mA |
| Operating temp | +85°C |
| Mounting | DIN rail |
...
| 17 | TX1 | UART/DIGITAL IN/DIGITAL OUT/ANALOG IN | Native MCU GPIO | Accessible through Expansion Port |
| 18 | RX1 | UART/DIGITAL IN/DIGITAL OUT/ANALOG IN | Native MCU GPIO | Accessible through Expansion Port |
...
| 39 | IO39 | DIGITAL IN/DIGITAL OUT | Native MCU GPIO | Accessible through Expansion Port |
